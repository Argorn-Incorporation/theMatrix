...
<form action="https://thematrixuk.com/payment/callback" method="POST" id="wecashup">

    <script async src="https://www.wecashup.com/library/MobileMoney.js" class="wecashup_button"
            data-demo
            data-sender-lang="en"
            data-sender-phonenumber=""
            data-receiver-uid="vRdEQd3PNdT8CvWzLdWx3aZvxYm2"
            data-receiver-public-key="pk_live_AQnZPV8XIcakL52j"
